<template>
  <el-dialog
    ...
    <el-form-item label="创建时属性" prop="spuAttributes">
      <el-input v-model="dataForm.spuAttributes" placeholder="创建时属性"></el-input>
    </el-form-item>
    ...
    <el-form-item label="会员头像" prop="memberIcon">
      <el-input v-model="dataForm.memberIcon" placeholder="会员头像"></el-input>
    </el-form-item>
    <el-form-item label="评论类型[0 - 商品直接评论，1 - 评论的回复]" prop="commentType">
      <el-input v-model="dataForm.commentType" placeholder="评论类型[0 - 商品直接评论，1 - 评论的回复]"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          spuAttributes: [
            { required: true, message: '创建时属性不能为空', trigger: 'blur' }
          ],
          likesCount: [
          ...
          commentType: [
            { required: true, message: '评论类型[0 - 商品直接评论，1 - 评论的回复]不能为空', trigger: 'blur' }
          ]
        }
      }
    },
