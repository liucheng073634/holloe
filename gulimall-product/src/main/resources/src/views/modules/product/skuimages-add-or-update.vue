<template>
  <el-dialog
    ...
    <el-form-item label="是否默认图片[0 - 不是默认图片，1 - 是默认图片]" prop="defaultImg">
      <el-input v-model="dataForm.defaultImg" placeholder="是否默认图片[0 - 不是默认图片，1 - 是默认图片]"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          defaultImg: [
            { required: true, message: '是否默认图片[0 - 不是默认图片，1 - 是默认图片]不能为空', trigger: 'blur' }
          ]
        }
      }
    },
