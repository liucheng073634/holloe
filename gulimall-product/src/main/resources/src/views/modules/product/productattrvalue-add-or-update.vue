<template>
  <el-dialog
    ...
    <el-form-item label="产品id" prop="spuId">
      <el-input v-model="dataForm.spuId" placeholder="产品id"></el-input>
    </el-form-item>
    ...
    <el-form-item label="是否显示在介绍页面，如果需要显示在sku页面，这个字段可以不用，或者设置为0-不显示 1-显示" prop="quickShow">
      <el-input v-model="dataForm.quickShow" placeholder="是否显示在介绍页面，如果需要显示在sku页面，这个字段可以不用，或者设置为0-不显示 1-显示"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          quickShow: [
            { required: true, message: '是否显示在介绍页面，如果需要显示在sku页面，这个字段可以不用，或者设置为0-不显示 1-显示不能为空', trigger: 'blur' }
          ]
        }
      }
    },
