<template>
  <el-dialog
    ...
    <el-form-item label="是否显示在介绍页面，如果需要显示在sku页面，这个字段可以不用，或者设置为0-不显示 1-显示" prop="showDesc">
      <el-input v-model="dataForm.showDesc" placeholder="是否显示在介绍页面，如果需要显示在sku页面，这个字段可以不用，或者设置为0-不显示 1-显示"></el-input>
    </el-form-item>
    </el-form>
