<template>
  <el-dialog
    ...
    <el-form-item label="属性分组名" prop="attrGroupName">
      <el-input v-model="dataForm.attrGroupName" placeholder="属性分组名"></el-input>
    </el-form-item>
  ...
  export default {
    data () {
      return {
        ...
        dataRule: {
          attrGroupName: [
            { required: true, message: '属性分组名不能为空', trigger: 'blur' }
          ],
          sort: [
