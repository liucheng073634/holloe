<template>
  <el-dialog
    ...
    <el-form-item label="消费优惠金额" prop="couponAmount">
      <el-input v-model="dataForm.couponAmount" placeholder="消费优惠金额"></el-input>
    </el-form-item>
    ...
    <el-form-item label="收藏专题活动数量" prop="collectSubjectCount">
      <el-input v-model="dataForm.collectSubjectCount" placeholder="收藏专题活动数量"></el-input>
    </el-form-item>
    ...
    <el-form-item label="邀请好友数量" prop="inviteFriendCount">
      <el-input v-model="dataForm.inviteFriendCount" placeholder="邀请好友数量"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          couponAmount: [
            { required: true, message: '消费优惠金额不能为空', trigger: 'blur' }
          ],
          orderCount: [
          ...
          collectSubjectCount: [
            { required: true, message: '收藏专题活动数量不能为空', trigger: 'blur' }
          ],
          collectCommentCount: [
            { required: true, message: '收藏评论数量不能为空', trigger: 'blur' }
          ],
          inviteFriendCount: [
            { required: true, message: '邀请好友数量不能为空', trigger: 'blur' }
          ]
        }
      }
    },
