<template>
  <el-dialog
    ...
    <el-form-item label="来源[0-购物，1-管理员修改]" prop="sourceType">
      <el-input v-model="dataForm.sourceType" placeholder="来源[0-购物，1-管理员修改]"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          changeCount: [
            { required: true, message: '改变值（正负计数）不能为空', trigger: 'blur' }
          ],
          note: [
            { required: true, message: '备注不能为空', trigger: 'blur' }
          ],
          sourceType: [
            { required: true, message: '来源[0-购物，1-管理员修改]不能为空', trigger: 'blur' }
          ]
        }
      }
    },
