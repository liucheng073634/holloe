<template>
  <el-dialog
    ...
    <el-form-item label="来源[0-购物，1-管理员修改，2-其他]" prop="sourceTyoe">
      <el-input v-model="dataForm.sourceTyoe" placeholder="来源[0-购物，1-管理员修改，2-其他]"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          sourceTyoe: [
            { required: true, message: '来源[0-购物，1-管理员修改，2-其他]不能为空', trigger: 'blur' }
          ]
        }
      }
    },
