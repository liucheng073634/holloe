<template>
  <el-dialog
    ...
    <el-form-item label="省/直辖市" prop="province">
      <el-input v-model="dataForm.province" placeholder="省/直辖市"></el-input>
    </el-form-item>
    ...
    <el-form-item label="详细地址(省市区)" prop="detailAddress">
      <el-input v-model="dataForm.detailAddress" placeholder="详细地址(省市区)"></el-input>
    </el-form-item>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          province: [
            { required: true, message: '省/直辖市不能为空', trigger: 'blur' }
          ],
          city: [
          ...
          detailAddress: [
            { required: true, message: '详细地址(省市区)不能为空', trigger: 'blur' }
          ],
          areacode: [
