<template>
  <el-dialog
    ...
    <el-form-item label="等级所需成长值" prop="growthPoint">
      <el-input v-model="dataForm.growthPoint" placeholder="等级所需成长值"></el-input>
    </el-form-item>
    ...
    <el-form-item label="每消费可获成长值" prop="commentGrowthPoint">
      <el-input v-model="dataForm.commentGrowthPoint" placeholder="每消费可获成长值"></el-input>
    </el-form-item>
    <el-form-item label="是否有免运费特权" prop="priviledgeFreeFreight">
      <el-input v-model="dataForm.priviledgeFreeFreight" placeholder="是否有免运费特权"></el-input>
    </el-form-item>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          commentGrowthPoint: [
            { required: true, message: '每消费可获成长值不能为空', trigger: 'blur' }
          ],
          priviledgeFreeFreight: [
            { required: true, message: '是否有免运费特权不能为空', trigger: 'blur' }
          ],
          priviledgeMemberPrice: [
