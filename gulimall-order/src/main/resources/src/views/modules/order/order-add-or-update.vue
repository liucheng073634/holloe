<template>
  <el-dialog
    ...
    <el-form-item label="促销优惠金额（促销价、满减、阶梯价）" prop="promotionAmount">
      <el-input v-model="dataForm.promotionAmount" placeholder="促销优惠金额（促销价、满减、阶梯价）"></el-input>
    </el-form-item>
    ...
    <el-form-item label="发票人电话" prop="billReceiverPhone">
      <el-input v-model="dataForm.billReceiverPhone" placeholder="发票人电话"></el-input>
    </el-form-item>
    <el-form-item label="发票人邮箱" prop="billReceiverEmail">
      <el-input v-model="dataForm.billReceiverEmail" placeholder="发票人邮箱"></el-input>
    </el-form-item>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          billReceiverPhone: [
            { required: true, message: '发票人电话不能为空', trigger: 'blur' }
          ],
          billReceiverEmail: [
            { required: true, message: '发票人邮箱不能为空', trigger: 'blur' }
          ],
          receiverName: [
